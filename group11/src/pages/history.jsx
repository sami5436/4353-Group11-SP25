  ...
  const data = [
    {
      ...
      status: "Completed",
      description:
        "A community effort to clean up litter and improve the park environment.",
      volunteered: true,
    },
    {
      id: 2,
      ...
      status: "Upcoming",
      description:
        "An initiative to collect and distribute food to those in need in our community.",
      volunteered: false,
    },
    {
      id: 3,
      name: "Animal Shelter Support 3",
      date: "2024-05-20",
      city: "Dallas",
      state: "TX",
      ...
      status: "Upcoming",
      description:
        "Helping out at the shelter by feeding animals, cleaning cages, and assisting staff.",
      volunteered: false,
    },
    {
      id: 4,
      name: "Animal Shelter Support 1",
      date: "2024-05-20",
      city: "Dallas",
      state: "TX",
      address: "789 Shelter Rd",
            ...
            <tbody>
              {data.map((event) => (
                ...
                >
                  ...
                  <td className={`py-3 px-4 border-b border-gray-300 font-semibold ${event.status === "Upcoming" ? "text-green-600" : "text-gray-600"}`}>{event.status}</td>
                  <td className={`py-3 px-4 border-b border-gray-300 font-semibold ${event.volunteered ? "text-blue-600" : "text-red-600"}`}>{event.volunteered ? "Yes" : "No"}</td>
                </tr>
              ))}
            </tbody>
          </table>
