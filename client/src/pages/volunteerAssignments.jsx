...
function VolunteerAssignments() {
  ...
  const fetchAssignedEvents = () => {
    ...
    axios
      .get(`https://four353-group11-sp25.onrender.com/api/volunteers/volunteer/${volunteerId}/upcoming`)
      .then((response) => {
  ...
  const handleConfirmDelete = (eventId) => {
    ...
    axios
      .delete(`https://four353-group11-sp25.onrender.com/api/volunteers/event/${eventId}/volunteer/${volunteerId}`)
      .then(() => {
