...
function AdminManageVolunteers() {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://four353-group11-sp25.onrender.com/api/events/allVolunteers")
      .then((res) => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://four353-group11-sp25.onrender.com/api/events")
      .then((res) => {
  ...
  const handleDragEnd = (event) => {
    ...
    axios
      .post("https://four353-group11-sp25.onrender.com/api/events/addVolunteer", {
