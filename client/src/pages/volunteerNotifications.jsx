...
const VolunteerNotifications = () => {
    ...
    const checkEventReminders = async () => {
        try {
            await axios.get('https://four353-group11-sp25.onrender.com/api/notifications/check-all-reminders', 
    ...
    useEffect(() => {
        ...
        const loadData = async () => {
            ...
            let url = `https://four353-group11-sp25.onrender.com/api/notifications?recipientType=${recipientType}`;
            if (filter === 'unread') {
                url += '&unread=true';
            } else if (filter !== 'all') {
                url += `&type=${filter}`;
    ...
    const markAllAsRead = () => {
        axios.put(`https://four353-group11-sp25.onrender.com/api/notifications/markAllRead?recipientType=${recipientType}`, 
            {}, { withCredentials: true })
            .then(res => {
                if (res.data.success) {
    ...
    const markAsRead = (id) => {
        axios.put(`https://four353-group11-sp25.onrender.com/api/notifications/${id}/read`, {}, { withCredentials: true })
            .then(res => {
